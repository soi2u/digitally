...
const page1 = "오늘은 편리하게 금융 서비스를 이용할 수 있는 우리은행 앱을 실습해 보겠습니다. 먼저, 플레이스토어를 눌러 실행해 주세요.";
const page2 = "앱스토어 검색창을 눌러 줍니다.";
const page3 = "우리은행을 입력해 줍니다.";
const page4 = "우리은행을 눌러 설치 화면으로 이동합니다.";
const page5 = "우리은행 앱을 설치해 줍니다.";
const page6 = "우리은행 앱의 설치가 끝났다면, 열기를 눌러 실행해 줍니다.";
const page7 = "우리은행 앱의 실행 화면입니다. 한번 클릭해 넘어가 줍니다.";
const page8 = "우리은행 앱 서비스 이용을 위해 기기의 사진, 미디어, 파일 등에 접근할 수 있도록 허용을 눌러 줍니다.";
const page9 = "우리은행 앱에서 전화, 문자 등으로 연락할 수 있도록 허용을 눌러 줍니다.";
const page10 = "마지막으로 확인을 눌러 우리은행 앱 설치를 완료합니다. 모두 고생하셨습니다.";
