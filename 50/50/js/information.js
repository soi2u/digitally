...
const page1 = "우리WON뱅킹의 국민 비서 서비스를 이용해 보도록 하겠습니다. 먼저, 전체 메뉴를 확인하기 위해 우측 하단의 전체를 눌러 줍니다.";
const page2 = "생활혜택을 눌러 줍니다.";
const page3 = "생활금융 버튼을 눌러 줍니다.";
const page4 = "국민비서를 눌러 넘어가 줍니다.";
const page5 = "국민비서 알림 서비스 신청 화면입니다. 스크롤을 내려 아래로 내려가 줍니다.";
const page6 = "건강검진을 눌러 체크해 줍니다.";
const page7 = "국세고지서 발송 안내를 눌러 체크해 줍니다.";
const page8 = "알림 설정하기를 눌러 국민비서 알림 서비스 신청을 완료해 줍니다.";
const page9 = "전체 동의하기 버튼을 눌러 줍니다.";
const page10 = "전체 동의 버튼을 눌러 줍니다.";
const page11 = "전체 동의가 완료되었다면, 다음 버튼을 눌러 넘어가 줍니다.";
const page12 = "신청이 완료되었습니다. 확인 버튼을 누르면 종료됩니다. 모두 고생하셨습니다.";
